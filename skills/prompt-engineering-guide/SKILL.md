...
description: Use when designing or documenting a prompt engineering guide — prompt patterns, system prompts, few-shot examples, versioning, and drift monitoring. Triggers on "prompt engineering", "prompt guide", "system prompt", "few-shot", "prompt versioning", "human-in-the-loop".
user-invocable: true
---
...
Design and document a prompt engineering guide that delivers actionable, measurable results.
...
- Review any existing prompt engineering guide documents in the project
...
- Apply the selected framework to structure the prompt engineering guide
...
- Structure the prompt engineering guide using the output format below
