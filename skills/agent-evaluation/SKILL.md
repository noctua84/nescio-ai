...
description: Use when evaluating an AI agent — task completion, tool-use correctness, trajectory scoring, automation rate, and human-in-the-loop review. Triggers on "agent evaluation", "agent eval", "task completion rate", "tool-use accuracy", "trajectory", "automation rate".
user-invocable: true
---
...
Analyze and produce an agent evaluation that delivers actionable, measurable results.
...
- Review any existing agent evaluation documents in the project
...
- Apply the selected framework to structure the agent evaluation
...
- Structure the agent evaluation using the output format below
